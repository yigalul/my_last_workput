...
export const Widget: React.FC<WidgetProps> = ({ lastWorkout, workoutConfigs, onOpenLog, onOpenSettings }) => {
  ...
  const [selectedPlanType, setSelectedPlanType] = useState<WorkoutType>(WorkoutType.CHEST);
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          {Object.values(WorkoutType).map((t) => (
            <button
              ...
              className={`py-2 px-1 rounded-xl text-[11px] sm:text-xs font-semibold transition-all border truncate ${
                selectedPlanType === t
